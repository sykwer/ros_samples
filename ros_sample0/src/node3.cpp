...
class Node3{
  ...
  void callback(const ros_sample0::TimestampArray::ConstPtr &input_msg);
public:
  Node3();
};
...
Node3::Node3() : nh_("~") {
  ...
  pub_ = nh_.advertise<ros_sample0::TimestampArray>("output", 10);
}


void Node3::callback(const ros_sample0::TimestampArray::ConstPtr &input_msg) {
...

  {
    ...
    ros_sample0::TimestampArray msg = *input_msg;
